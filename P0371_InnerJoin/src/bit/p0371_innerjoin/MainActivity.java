...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//Вывод в лог данных по должностям
		...
		//вывод результата объединения таблиц  rawQuery
